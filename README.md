...
> **PWA instalable** con soporte offline completo (Cache v40), catálogo prerenderizado para SEO (Schema.org), panel privado de analítica con Luxury Glassmorphism y backend en la nube (Supabase Cloud + GA4) y suite de pruebas automatizadas en CI/CD.
...
10. [PWA: instalar y funcionamiento offline (Cache v40)](#pwa-instalar-y-funcionamiento-offline-cache-v40)
...
- **PWA Instalable (Cache v40):** Estrategia Network-First para navegación HTML (contenido siempre fresco con conexión) y Stale-While-Revalidate para recursos estáticos; precaching enfocado en shell, dashboard, iconos HD y miniaturas (`images/thumbs/`).
...
│
├── sw.js                          ← Service Worker PWA (Cache v40)
...
| **PWA & Offline** | Service Worker API | Cache v40, Network-First en navegación, manifest standalone |
...
### Arquitectura de Caché en `sw.js` (Cache v40)
...
| `sw.js` | Service Worker (Cache v40, Network-First navegación) |
