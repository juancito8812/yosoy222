...
- **[2026-09-06]** — **Documentación actualizada (AGENTS.md, README.md, MEMORY.md):** incluye ahora el comando rápido de regeneración + validación de iconos y la regla de formato (any=RGB plano, maskable=RGBA).
