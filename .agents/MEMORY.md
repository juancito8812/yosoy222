...
- **Última sesión:** 13 de septiembre de 2026, 17:00
...
- **Dashboard:** `dashboard.html` (`/dashboard.html`), `css/dashboard.css`, `js/dashboard.js` — autenticación criptográfica SHA-256, KPIs, gráficos en Canvas nativo, embudo de conversión, tabla de eventos y exportación CSV
...
- **PWA:** `manifest.json` (68 líneas) + `sw.js` (155 líneas, cache v15, Network-First para navegación, stale-while-revalidate para estáticos, query strings `?v=15`, `ignoreSearch: true`, offline total)
