...
- **Dashboard & Analítica Privada:** Telemetría sin cookies en `js/analytics.js` y panel de control en `dashboard.html` (`/dashboard.html`) con métricas de conversión, funnel, canales de tráfico y exportación CSV.
